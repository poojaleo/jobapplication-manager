...
public class DeleteJobApplicationRequest {
    ...
    public DeleteJobApplicationRequest(){
    }

    public DeleteJobApplicationRequest(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        DeleteJobApplicationRequest that = (DeleteJobApplicationRequest) o;
    ...
    public String toString() {
        return "DeleteJobApplicationRequest{" +
                "username='" + username + '\'' +
    ...
    public static final class Builder {
        ...
        public DeleteJobApplicationRequest build() { return new DeleteJobApplicationRequest(this);}
    }
}
